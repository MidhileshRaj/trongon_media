...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<TotalResponse?>(
      future: Provider.of<HomePageController>(context).getHomeData(),
      builder: (BuildContext context, AsyncSnapshot<TotalResponse?> snapshot) {
              ...
              children: [
                Container(
                  ...
                  child: CarouselSlider.builder(
                      ...
                      slideIndicator: CircularSlideIndicator(indicatorBackgroundColor: Colors.grey,currentIndicatorColor: Colors.amber.shade400,
